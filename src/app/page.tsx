...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-cream font-sans">
      ...
      <footer className="border-t border-cream-border px-6 py-6 flex justify-between items-center max-w-6xl mx-auto">
        <span className="font-display font-black text-lg text-ink-light tracking-tight">Herder</span>
        <span className="text-sm text-ink-light">© 2026 · Made with ♥ for teachers</span>
      </footer>
    </div>
  );
}
